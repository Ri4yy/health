          ...
          <div className="container">
            <div className="max-w-[900px] mx-auto text-center">
              ...
              <p className="text-lg text-[var(--color-neutral-600)] mb-6">
                Настоящее Пользовательское соглашение определяет условия использования сервиса Точка Баланса 
                    ...
                    <section id="general">
                      ...
                      <div className="space-y-4 text-[var(--color-neutral-700)]">
                        <p>
                          ...
                          между ООО «Точка Баланса» (далее — Администрация) и физическими лицами (далее — Пользователь), 
                      ...
                      <div className="space-y-4 text-[var(--color-neutral-700)]">
                        ...
                        <div className="p-6 bg-[var(--color-neutral-50)] rounded-[12px] mt-8">
                          ...
                          <div className="space-y-2 text-sm">
                            <p><strong>ООО «Точка Баланса»</strong></p>
                            <p>ИНН: 1234567890</p>
